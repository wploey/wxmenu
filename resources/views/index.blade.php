<div id="{{$id}}">
    <div class="row custom-menu-wraper" v-if="menuType=='mobile'">
                            ...
                            <div class="sub_pre_menu_box">
                                <ul class="sub_pre_menu_list">
                                    ...
                                    <li class="sub_pre_menu_item" v-if="!item.sub_button || item.sub_button.length < 5">
                                        <a href="javascript:void(0);" class="custom-a-button" title="最多添加五个子菜单"
                    ...
                    <div class="form-horizontal">
                        ...
                        <div v-if="!nowItem.sub_button||!nowItem.sub_button.length">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="radio menu-type-select" v-for="item,index in menuTypeList.mobile">
                                        <label :for="index">
    ...
    <div class="row custom-menu-wraper" v-if="menuType=='pc'">
        <div class="col-md-12">
            <div class="custom-phone-box-pc">
                <h3 class="custom-nav-title">{{$label}}</h3>
                <div class="custom-phone-footer-pc">
                    <ul class="pre_menu_list">
                        <li class="jsMenu pre_menu_item "
                            v-bind:class="{ selected: zindex == index , active: zindex == index&&subZindex ==-1 }"
                            v-for="item,index in menu.button">
                            ...
                            <div class="sub_pre_menu_box sub_pre_menu_box-pc">
                                <i class="arrow-pc arrow_out-pc"></i>
                                <i class="arrow-pc arrow_in-pc"></i>
                                <ul class="sub_pre_menu_list">
                                    <li class="sub_pre_menu_item" v-if="!item.sub_button || item.sub_button.length < 5">
                                        <a href="javascript:void(0);" class="custom-a-button" title="最多添加五个子菜单"
                                           v-on:click="addMenuHandler(1)">
                        ...
                        <li class="pre_menu_item" v-if="menu.button.length < 10">
                            <a href="javascript:void(0);" class="custom-a-button" title="最多添加十个菜单" v-on:click="addMenuHandler(0)">
                                <i class="custom-svg-size">
                                </i>
                            </a>
                        </li>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div v-if="!nowItem.sub_button||!nowItem.sub_button.length">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">菜单类型：</label>
                                <div class="col-sm-10">
                                    <div class="radio menu-type-select" v-for="item,index in menuTypeList.pc">
                                        <label :for="index">
                                            <input type="radio" name="menuType" v-model="nowItem.type" :id="index"
                                                   v-on:click="selectedMenuType(item.value)" :value="item.value" />
                                            <?php echo"{{ item.label }}" ?>
